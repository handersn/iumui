...
COMMENT ON COLUMN iboard.open_state IS '공개여부';

COMMENT ON COLUMN iboard.click_count IS '조회수';

COMMENT ON COLUMN iboard.good_count IS '추천수';
...
CREATE TABLE ggroup (
	...
	gintro VARCHAR2(50) NOT NULL, /* 모임소개 */
...
CREATE TABLE bmaster (
	bmno INTEGER NOT NULL, /* 게시판구분번호 */
	bcategory VARCHAR2(50) NOT NULL /* 분류명 */
);
...
CREATE TABLE slocal (
	lcode VARCHAR2(50) NOT NULL, /* 지역분류코드 */
	lname VARCHAR2(50) NOT NULL /* 분류명 */
);
